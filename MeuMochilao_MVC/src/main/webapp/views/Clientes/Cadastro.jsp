...
<body>
    <div class="main">
        ...
        <!--FORMULÁRIO-->
        <form action="../../clientes-create" class="row g-3">
            <div class="col-12">
            ...
            <div class="col-md-6">
                ...
                <input type="number" class="form-control" placeholder="Digite seu CPF" aria-label="Digite seu CPF">
            </div>
            <div class="col-md-6">
                <label for="inputCity" class="form-label">Cidade</label>
                <input type="text" class="form-control" placeholder="Digite sua cidade">
            </div>
            <form class="col-12" size="100vh">
                <div class="col-12">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="gridCheck">
                        <label class="form-check-label" for="gridCheck">
                            Desejo receber a newsletter do site Meu Mochilão.
                        </label>
                    </div>
                </div>
                <div class="col-12">
