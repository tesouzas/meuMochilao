            ...
            <form action="./reserva-create">
                <fieldset>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="ida" name="ida" class="form-control" placeholder="ida" value="<%=request.getAttribute("ida") %>" />
                    </div>
                    <div class="form-group mb-3">
                        <label for="volta" class="form-label">
                            Dia da volta
                        </label>
                        <input type="text" id="volta" name="volta" class="form-control" placeholder="volta" value="<%=request.getAttribute("volta") %>" />
                    </div>
                     <div class="form-group mb-3">
